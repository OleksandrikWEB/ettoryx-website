...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    bio: { uk: "Забезпечує якість кожного релізу через ретельне тестування.", en: "Ensures the quality of every release through rigorous testing." },
    leadership: true,
    linkedin: "#",
  ...
  },
  {
    ...
    bio: { uk: "Створює AI-системи та конвеєри автоматизації.", en: "Builds AI systems and automation pipelines." },
    leadership: true,
    linkedin: "#",
  ...
  },
  {
    ...
    name: "Orest Palanii",
    role: { uk: "AI Engineer", en: "AI Engineer" },
    bio: { uk: "Розробляє AI-моделі та інтелектуальні інтеграції.", en: "Develops AI models and intelligent integrations." },
    leadership: true,
    linkedin: "#",
  ...
  },
  {
    ...
    role: { uk: "AI Engineer", en: "AI Engineer" },
    bio: { uk: "Створює AI-функції та рішення для роботи з даними.", en: "Engineers AI-driven features and data solutions." },
    leadership: true,
    linkedin: "#",
